"""Shared CLI banner — ASCII "BUGHUNTER" logo with a blue→cyan→magenta gradient.
...
# Blue → cyan → magenta gradient for 256-color terminals.
_GRADIENT_256 = [
    "\033[38;5;63m", "\033[38;5;75m", "\033[38;5;87m",
    "\033[38;5;51m", "\033[38;5;99m", "\033[38;5;129m",
]
# 8-color fallback for terminals without 256-color support.
_GRADIENT_8 = [
    "\033[1;34m", "\033[0;36m", "\033[1;36m",
    "\033[0;36m", "\033[1;35m", "\033[0;35m",
]
