    ...
    if _bb_use_color; then
        case "${COLORTERM:-}:${TERM:-}" in
            truecolor:*|24bit:*|*:*256*|*:xterm*)
                C1=$'\033[38;5;63m'; C2=$'\033[38;5;75m'; C3=$'\033[38;5;87m'
                C4=$'\033[38;5;51m'; C5=$'\033[38;5;99m'; C6=$'\033[38;5;129m'
                ;;
            *)
                C1=$'\033[1;34m'; C2=$'\033[0;36m'; C3=$'\033[1;36m'
                C4=$'\033[0;36m'; C5=$'\033[1;35m'; C6=$'\033[0;35m'
                ;;
        esac
